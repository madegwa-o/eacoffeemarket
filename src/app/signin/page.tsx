        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12">
            <Card className="w-full max-w-md">
                <CardHeader className="space-y-1">
                    <CardTitle className="text-2xl font-bold text-center">Welcome to eacm</CardTitle>
                    <CardDescription className="text-center">Sign in to access your EACM account</CardDescription>
                </CardHeader>
